    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-[#7c3aed]/20 via-transparent to-[#0891b2]/20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-[#8b5cf6] opacity-10 blur-[100px] rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#8b5cf6]/20 text-[#a78bfa] border border-[#8b5cf6]/40 mb-6", children: "🚀 LIMITED SEATS AVAILABLE" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "reveal font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-6 leading-tight", children: [
            "Start Your ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Digital Marketing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Career Today"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal text-foreground/70 text-xl mb-10 max-w-2xl mx-auto", children: "Join 5,000+ students who transformed their careers. New batch starting soon — limited seats available." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal flex flex-col sm:flex-row gap-4 justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: "🎓 Enroll Now — Start Learning"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.querySelector("#pricing")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-foreground/50", children: [
...
function ContactSection() {
  ...
  const inputClass = "w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-foreground text-sm placeholder:text-foreground/40 focus:outline-none focus:border-[#8b5cf6]/60 focus:bg-white/8 transition-all duration-200";
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#8b5cf6]/15 text-[#a78bfa] border border-[#8b5cf6]/30 mb-4", children: "FREE DEMO CLASS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-6", children: [
            "Ready to ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Start Learning?" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-lg mb-8 leading-relaxed", children: "Book your free 90-minute demo class with our experts. No obligations, no credit card required. Experience the DigiPro Academy difference firsthand." }),
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/50", children: item.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-foreground/80 font-medium", children: item.value })
                ] })
              ]
            },
            item.label
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal", style: { transitionDelay: "150ms" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-card p-8", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl gradient-text mb-3", children: "You're All Set!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70", children: "Our counselor will call you within 2 hours to schedule your free demo class. Check your email for a confirmation." })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, noValidate: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl mb-6 text-foreground", children: "Book Your Free Demo" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", className: "bg-[#0a0a1a]", children: "Select a course..." }),
                    courseOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "option",
                      {
                        value: opt,
                        className: "bg-[#0a0a1a]",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-foreground/40 mt-3", children: "No spam. We respect your privacy. 🔒" })
        ] }) }) })
      ] }) })
    }
  );
...
const courses = [
  {
    ...
    description: "Master Facebook, Instagram, LinkedIn, and Twitter strategies to grow organic reach and build brand authority.",
  ...
  },
  {
    ...
    description: "Run high-converting Facebook and Instagram ad campaigns with advanced targeting, retargeting, and lookalike audiences.",
    badge: "Most Popular",
  ...
  },
  {
    ...
    description: "Leverage ChatGPT, Midjourney, and 20+ AI tools to automate and supercharge your marketing campaigns.",
    badge: "Trending 🔥",
  ...
  },
  {
    ...
    description: "Create viral content, plan editorial calendars, and craft compelling copy that converts followers into customers.",
  ...
  },
  {
    ...
    description: "Build high-quality lead funnels using landing pages, email marketing, and multi-channel paid acquisition.",
  ...
  },
  {
    ...
    description: "Master Google Ads, analytics, conversion rate optimization, and ROI-driven campaign management at scale.",
    badge: "Advanced",
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#8b5cf6]/15 text-[#a78bfa] border border-[#8b5cf6]/30 mb-4", children: "WHAT YOU'LL LEARN" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-4", children: [
            "Course ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Highlights" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-2xl mx-auto text-lg", children: "Comprehensive curriculum designed by industry experts to make you job-ready in 90 days." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: courses.map((course, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg mb-2 text-foreground", children: course.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 text-sm leading-relaxed", children: course.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-1 text-[#8b5cf6] text-sm font-medium", children: [
                "Explore Module",
...
function CurriculumSection() {
  const [activeModule, setActiveModule] = reactExports.useState(0);
  const sectionRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#8b5cf6]/15 text-[#a78bfa] border border-[#8b5cf6]/30 mb-4", children: "FULL CURRICULUM" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-4", children: [
            "Course ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Timeline" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-2xl mx-auto text-lg", children: "14-week comprehensive program — from zero to job-ready digital marketer." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#8b5cf6] via-[#06b6d4] to-[#8b5cf6] opacity-30 hidden sm:block" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: modules.map((module, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "reveal",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `glass-card px-6 py-4 flex items-center gap-4 ${activeModule === i ? "border-[#8b5cf6]/40 bg-white/[0.07]" : ""}`,
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `shrink-0 w-12 h-12 rounded-xl font-display font-bold text-sm flex items-center justify-center transition-all duration-300 ${activeModule === i ? "btn-gradient text-white shadow-[0_0_20px_rgba(139,92,246,0.4)]" : "bg-white/5 text-foreground/60 border border-white/10 group-hover:bg-white/10"}`,
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground group-hover:text-[#a78bfa] transition-colors", children: module.title }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-xs text-foreground/50 glass px-2 py-1 rounded-full", children: module.duration }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  className: `text-lg transition-transform duration-300 ${activeModule === i ? "rotate-180" : ""}`,
                                  children: "↓"
                                }
                              )
                            ] })
                ...
                activeModule === i && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-0 sm:ml-16 mt-2 glass-card p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: module.topics.map((topic) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex items-start gap-2 text-sm text-foreground/70",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#8b5cf6] mt-0.5 shrink-0", children: "✓" }),
                      topic
                    ]
                  },
                  topic
...
function FAQSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", ref: sectionRef, "data-ocid": "faq.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#8b5cf6]/15 text-[#a78bfa] border border-[#8b5cf6]/30 mb-4", children: "GOT QUESTIONS?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-4", children: [
        "Frequently Asked ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Questions" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60", children: "Can't find an answer? Reach us at hello@digipro.academy" })
    ] }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground group-hover:text-[#a78bfa] transition-colors", children: faq.q }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-lg transition-all duration-300 ${openIndex === i ? "btn-gradient text-white rotate-180" : "bg-white/5 text-foreground/60 border border-white/10"}`,
                    children: "↓"
                  }
                )
              ]
          ...
          openIndex === i && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 pt-4 text-foreground/70 text-sm leading-relaxed", children: faq.a }) })
        ]
      },
      faq.q
    )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg btn-gradient flex items-center justify-center text-white font-bold", children: "D" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "DigiPro" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/80", children: " Academy" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 text-sm leading-relaxed mb-6", children: "India's leading digital marketing institute. Transforming careers with practical training, AI tools, and guaranteed placement support since 2019." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: socialLinks.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SocialIcon, { ...s }, s.label)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-4", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: quickLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#8b5cf6] text-xs", children: "›" }),
                  link.label
                ]
              }
            ) }, link.href)) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-4", children: "Our Courses" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: [
              ...
              "Performance Marketing",
              "Lead Generation"
            ].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground/60 text-sm flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#06b6d4] text-xs", children: "›" }),
              c
            ] }) }, c)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-4", children: "Contact Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-foreground/60", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base mt-0.5", children: "📧" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "hello@digipro.academy" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-foreground/60", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base mt-0.5", children: "📞" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-foreground/60", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base mt-0.5", children: "📍" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "DigiPro Academy, Baner Road, Pune — 411045, Maharashtra, India" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-foreground/60", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base mt-0.5", children: "🕐" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Mon–Sat: 9:00 AM – 7:00 PM" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-foreground/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "© ",
            year,
            " DigiPro Academy. All rights reserved."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 -left-1/4 w-[600px] h-[600px] rounded-full bg-[#8b5cf6] opacity-[0.08] blur-[120px]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 -right-1/4 w-[500px] h-[500px] rounded-full bg-[#06b6d4] opacity-[0.08] blur-[100px]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[200px] bg-gradient-to-t from-[#8b5cf6]/5 to-transparent blur-[60px]" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal hero-reveal mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm font-medium text-[#a78bfa]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-[#8b5cf6] animate-pulse" }),
              "India's #1 Digital Marketing Course"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "reveal hero-reveal font-display font-bold text-4xl sm:text-5xl lg:text-6xl leading-tight mb-6", children: [
              "Master ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Digital Marketing," }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Meta Ads" }),
              " & AI Skills"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal hero-reveal text-foreground/70 text-lg mb-8 leading-relaxed max-w-lg", children: "Learn practical digital marketing from experts and build a high-paying career or grow your business. Real projects, real results." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal hero-reveal flex flex-wrap gap-3 mb-8", children: trustBadges.map((badge) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal hero-reveal flex flex-wrap gap-4 mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => {
                    var _a2;
                    return (_a2 = document.querySelector("#curriculum")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal hero-reveal flex items-center gap-3 text-sm text-foreground/60", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-400 text-lg", children: "★" }, s)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal hero-reveal relative flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-float", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -top-4 -left-8 glass px-4 py-3 rounded-xl shadow-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/60", children: "Monthly Reach" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-lg gradient-text", children: "2.4M+" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 -right-6 glass px-4 py-3 rounded-xl shadow-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/60", children: "Ad ROAS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-lg text-[#06b6d4]", children: "4.8x" })
            ] })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass border-t border-white/10 grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 px-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-2xl gradient-text", children: stat.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/60 mt-0.5", children: stat.label })
        ] }, stat.label)) }) }) })
      ]
    }
  );
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[rgba(10,10,26,0.95)] backdrop-blur-xl border-b border-white/10 shadow-lg" : "bg-transparent"}`,
      "data-ocid": "navbar",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg btn-gradient flex items-center justify-center text-white text-sm font-bold", children: "D" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "DigiPro" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/80", children: "Academy" })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                type: "button",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-0.5 bg-current mb-1 transition-all" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-0.5 bg-current mb-1 transition-all" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-0.5 bg-current transition-all" })
                ]
              }
            )
          ] })
        ] }),
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden glass border-t border-white/10 px-4 pb-4", children: [
...
const plans = [
  {
    ...
    price: "₹4,999",
    duration: "/ one-time",
    description: "Perfect for beginners exploring digital marketing fundamentals.",
    features: [
      "Social Media Marketing",
  ...
  },
  {
    ...
    price: "₹9,999",
    duration: "/ one-time",
    description: "Most popular. Complete marketing toolkit for career-starters.",
    features: [
      "Everything in Basic",
      "Meta Ads Mastery",
      "Google Ads Training",
  ...
  },
  {
    ...
    price: "₹14,999",
    duration: "/ one-time",
    description: "Complete career transformation with 1:1 mentorship and agency training.",
    features: [
      "Everything in Pro",
...
function PricingSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#06b6d4]/15 text-[#06b6d4] border border-[#06b6d4]/30 mb-4", children: "PRICING PLANS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-4", children: [
            "Choose Your ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Learning Path" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-xl mx-auto text-lg", children: "One-time payment, lifetime value. No hidden fees, no monthly subscriptions." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 items-start", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `glass-card p-6 reveal relative ${plan.popular ? "border-[#8b5cf6]/50 shadow-[0_0_30px_rgba(139,92,246,0.2)] scale-[1.02]" : ""}`,
            style: { transitionDelay: `${i * 100}ms` },
            "data-ocid": `pricing.item.${i + 1}`,
            children: [
              plan.popular && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "btn-gradient px-4 py-1.5 rounded-full text-xs font-bold text-white whitespace-nowrap", children: "⭐ Most Popular" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl mb-1 text-foreground", children: plan.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 text-sm mb-4", children: plan.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/50 text-sm", children: plan.duration })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 mb-6", children: plan.features.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex items-start gap-2 text-sm text-foreground/75",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#8b5cf6] shrink-0 mt-0.5", children: "✓" }),
                    feature
                  ]
                },
                feature
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `w-full py-3 rounded-full font-semibold text-sm transition-all cursor-pointer ${plan.popular ? "btn-gradient text-white shadow-[0_0_20px_rgba(139,92,246,0.3)]" : "btn-outline-glass text-foreground"}`,
...
function TestimonialsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#8b5cf6]/15 text-[#a78bfa] border border-[#8b5cf6]/30 mb-4", children: "STUDENT SUCCESS STORIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-4", children: [
            "What Our ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Students Say" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-xl mx-auto", children: "Real results from real students. No fake testimonials, ever." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal max-w-3xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 mb-6", "data-ocid": "testimonials.card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 mb-6", children: "★".repeat(t.rating).split("").map((star, i) => (
              // biome-ignore lint/suspicious/noArrayIndexKey: star position is stable within fixed-length rating array
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-400 text-xl", children: star }, i)
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "text-foreground/85 text-lg leading-relaxed mb-8 italic", children: [
              '"',
              t.text,
              '"'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-semibold text-foreground", children: t.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-foreground/60", children: t.role })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: testimonials.map((t2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => resetTimer(() => setCurrent(i)),
                className: `rounded-full transition-all duration-300 ${i === current ? "w-8 h-2 btn-gradient" : "w-2 h-2 bg-white/20 hover:bg-white/40"}`,
...
const features = [
  {
    icon: "🏗️",
    title: "Live Projects",
    description: "Work on real client campaigns from day one. Build an actual portfolio that impresses employers."
  },
  {
    icon: "⚡",
    title: "100% Practical Training",
    description: "No theory overload. Every concept is immediately applied through hands-on exercises and assignments."
  },
  {
    icon: "💼",
    title: "Placement Assistance",
    description: "Dedicated placement team connects you with 200+ hiring partner agencies and brands."
  },
  {
    icon: "🤖",
    title: "AI Tools Training",
    description: "Be ahead of the curve. Learn 30+ AI marketing tools including ChatGPT, Gemini, and Jasper."
  },
  {
    icon: "♾️",
    title: "Lifetime Access",
    description: "Course materials, updates, and community access never expire. Learn at your own pace."
  },
  {
    icon: "🎓",
    title: "Industry Certification",
    description: "Receive Google, Meta, and DigiPro Academy certifications recognized by top employers."
  }
];
function WhyUsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", ref: sectionRef, "data-ocid": "whyus.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#06b6d4]/15 text-[#06b6d4] border border-[#06b6d4]/30 mb-4", children: "WHY DIGIPRO ACADEMY" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl lg:text-5xl mb-4", children: [
        "Why ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Choose Us" }),
        "?"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 max-w-2xl mx-auto text-lg", children: "We don't just teach. We transform careers with a proven methodology trusted by 5,000+ students." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: features.map((feature, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-gradient-to-br from-[#8b5cf6]/20 to-[#06b6d4]/20 border border-white/10 flex items-center justify-center text-3xl mb-4 group-hover:shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all duration-300", children: feature.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg mb-2 text-foreground", children: feature.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 text-sm leading-relaxed", children: feature.description })
        ]
      },
      feature.title
    )) })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { backgroundColor: "#0a0a1a" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CoursesSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WhyUsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CurriculumSection, {}),
